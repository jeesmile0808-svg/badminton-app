...
## อัปเดต: ระบบคำนวณค่าใช้จ่าย (เวอร์ชันใหม่)

ตารางเปลี่ยนจากระบบ "ติ๊กสนาม 1/2/3" เป็นระบบคำนวณค่าใช้จ่ายจริงตามตารางคำนวณของกลุ่ม:

- **ออนไลน์**: ปุ่มสีเขียว/แดง บอกว่าคนนั้นมาเล่นวันนี้หรือไม่
- **จำนวนเกมส์**: ใส่จำนวนเกมส์ที่แต่ละคนเล่น (ถ้าไม่ออนไลน์ ระบบจะล็อกเป็น 0 อัตโนมัติ)
- **ค่าสนาม / ค่าลูก / รวมต่อคน**: คำนวณอัตโนมัติ แบ่งตามสัดส่วนจำนวนเกมส์ที่เล่น เทียบกับผลรวมเกมส์ทั้งหมด
- ตั้งค่าราคาต่อลูก, จำนวนลูกที่ใช้, ค่าสนามต่อชั่วโมง, จำนวนชั่วโมง ได้ในการ์ด "ตั้งค่าราคา"
- ด้านล่างมีสรุปยอด: ราคาลูกทั้งหมด, ค่าสนามรวม, จำนวนผู้เล่น, จำนวนเกมส์รวม, เกมส์ทั้งหมด(แมตช์), และยอดรวมที่ต้องเก็บ

⚠️ **ข้อมูลไม่ถาวรถ้าใช้ Render แผนฟรี**: ทุกครั้งที่ deploy ใหม่ ดิสก์จะถูกล้าง ข้อมูลตาราง (ใครมา/เล่นกี่เกมส์) จะรีเซ็ต แนะนำให้กด "Sync ไป Google Sheet" ทุกครั้งหลังใช้งานเสร็จ เพื่อเก็บผลไว้ถาวรในชีต
